...
description: |-
  The LabPlatform provider manages the DesoLabs training platform as code — users, courses, classes, connection templates, and student assignments.
---

# LabPlatform Provider

The LabPlatform provider allows you to manage the entire [DesoLabs LabPlatform](https://labplatform.desolabs.it) declaratively using Terraform. You can create and manage users, courses, classes, connection templates, Git connections, vSphere endpoints, and student assignments.
