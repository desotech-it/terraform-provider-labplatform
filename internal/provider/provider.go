...
func (p *labplatformProvider) Schema(_ context.Context, _ provider.SchemaRequest, resp *provider.SchemaResponse) {
	resp.Schema = schema.Schema{
		Description: "Terraform provider for DesoLabs LabPlatform. Manages users, courses, sessions, connection templates, and lab environments.",
